          ...
          <div className="tile is-ancestor">
            <div className="tile is-4 is-vertical is-parent">
              <div className="tile is-child box">
                <p className="title" id="colorme">Web</p>
              ...
              <div className="tile is-child box">
                <p className="title" id="colorme">Mobile</p>
            ...
            <div className="tile is-parent">
              <div className="tile is-child box">
                ...
                <section className="section">
                  <h3 className="title"> <a id="linktitle" href="https://github.com/bretth18">                <a className="icon" id="iconman" href="https://github.com/bretth18">
                                    <i className="fa fa-github fa-4x"></i>
                                  </a>github portfolio</a></h3>
                </section>
